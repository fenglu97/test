...
class AssetController extends AdminbaseController {
    ...
    public function plupload(){
        ...
        if (IS_POST) {
            ...
            $upload_max_filesize=$upload_setting['file']['upload_max_filesize'];
            ...
            if ($info) {
                ...
                $filepath = str_replace('www.sy217.com','',C('UPLOADPATH')).$savepath.$first['savename'];
            ...
            $this->assign('upload_max_filesize_mb',intval($upload_max_filesize/1024/1024));
