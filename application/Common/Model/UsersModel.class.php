...
class UsersModel extends CommonModel
{
	...
	protected $_validate = array(
		...
		array('mobile', 'checkMobile', '手机号已经存在！', 1, 'callback', CommonModel:: MODEL_BOTH),// 验证mobile字段是否唯一
	...
	protected $_auto = array(
        ...
        array('effective','getTime',3,'callback'),
	...
	function getTime(){
	    $time  = $_POST['effective'];
	    if($time){
	        return strtotime($time);
        }else{
	        return strtotime($this->mGetDate());
        }
    }
