...
function uc_user_register_r($username, $password,  $questionid = '', $answer = '', $regip = '') {

	return call_user_func(UC_API_FUNC, 'user', 'register', array('username'=>$username, 'password'=>$password,  'questionid'=>$questionid, 'answer'=>$answer, 'regip' => $regip));
